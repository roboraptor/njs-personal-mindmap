...
### 2. Inicializace databáze a nahrání ukázky
Tímto se automaticky vytvoří lokální SQLite databáze (`mindmap.db`) a rovnou se do ní nahraje krásná testovací mapa, ať si můžete vše hned vyzkoušet.
```bash
